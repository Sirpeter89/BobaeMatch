...
export default function ChatComponent(props) {
    ...
    if (!userToTalkWithName) {
        pickUser = <div className="pick-input">Select a Bobae to chat with!</div>
    } else {
        pickUser = (
            <div className="chat-area">
                ...
                <div className="chat-view">
                    {messages.map((message, ind) => (
                        <div className="chat-text" key={ind}>
                ...
                <form onSubmit={sendChat} className="chat-input">
                    <input value={chatInput} onChange={updateChatInput} className="input-element" />
            ...
            <div className="chat-container disabled" ref={chatRef}>
                <div className="names-chat-container">
                    {props.matchData.map((person, ind) => (
                        <div
                            key={ind}
                            onClick={() => joinChat(`${person[2]}`, `${person[0].username}`)}
